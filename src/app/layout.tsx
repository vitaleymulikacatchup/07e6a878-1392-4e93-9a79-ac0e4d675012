...
export const metadata: Metadata = {
  title: "Explore Estonia | Uncover Its Charm",
  description: "Your guide to the stunning landscapes and rich history of Estonia.",
  keywords: "Estonia, travel, tourism, landscapes, history",
  openGraph: {
    title: "Explore Estonia | Uncover Its Charm",
    description: "Your guide to the stunning landscapes and rich history of Estonia.",
    url: "",
    siteName: "Estonia Tours",
    images: [{
      url: "https://images.pexels.com/photos/2953806/pexels-photo-2953806.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
  ...
  twitter: {
    ...
    title: "Explore Estonia | Uncover Its Charm",
    description: "Your guide to the stunning landscapes and rich history of Estonia.",
    images: ["https://images.pexels.com/photos/2953806/pexels-photo-2953806.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
